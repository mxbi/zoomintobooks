...
//      }
      ...
      Bitmap bitmap = null;
      try (InputStream is = getAssets().open("sartre.jpg")) {
        bitmap = BitmapFactory.decodeStream(is);
      } catch (IOException e) {
        Log.e(TAG,"Something went wrong Victoria", e);
      }

      augmentedImageDatabase.addImage("sartre", bitmap, 0.15f);
      ...
      try (InputStream is = getAssets().open("Images.imgdb")) {
