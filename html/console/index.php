...
if ($authorised) {
    ...
    if (authorised("list books", array(), $errors=false))        echo "    <a class=\"card\" href=\"books/\"><img src=\"/assets/images/icons/book-stack-128.png\" alt=\"\"/><span class=\"card-label\">Manage books</span></a>\n";
    if (authorised("list resources", array(), $errors=false))    echo "    <a class=\"card\" href=\"resources/\"><img src=\"/assets/images/icons/pages-1-128.png\" alt=\"\" /><span class=\"card-label\">Manage resources</span></a>\n";
